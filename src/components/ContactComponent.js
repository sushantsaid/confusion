...
class Contact extends Component{
    ...
    //Function to check whether any input value is touched(changed) or not and do we need to validate it 
    handleBlur = (field) =>(evt)=>{
        this.setState({
            //if any input value is touched(changed) then mark its "touched" value as true
            touched : {...this.state.touched,[field] : true} 
            // ""...this.state.touched" means that all the values of "this.state.touched"
        })
    }
